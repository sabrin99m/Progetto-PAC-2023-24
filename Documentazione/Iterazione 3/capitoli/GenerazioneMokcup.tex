...
\end{figure}
\begin{figure}[ht]
  \includegraphics[width=\linewidth]{Iterazione 3/images/prompt2.png}
  \caption{Secondo prompt e risposta}\label{fig:prompt2}
\end{figure}
\begin{figure}[ht]
  \includegraphics[width=\linewidth]{Iterazione 3/images/prompt3.png}
  \caption{Primo prompt per la generazione di utenti}\label{fig:prompt3}
\end{figure}
\begin{figure}[ht]
  \includegraphics[width=\linewidth]{Iterazione 3/images/answer2.png}
  \caption{Risposta parziale al primo prompt}\label{fig:answ2}
\end{figure}
\begin{figure}[ht]
  \includegraphics[width=\linewidth]{Iterazione 3/images/prompt4.png}
